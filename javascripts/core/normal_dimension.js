...
function hasInfinityMult(tier) {
    ...
    function multiplySameCosts(cost) {
        ...
        var tierCosts = [ null, new Decimal(4e5), new Decimal(3e6), new Decimal(2e9), new Decimal(2e11), new Decimal(9e14), new Decimal(5e18), new Decimal(3e22), new Decimal(1e28) ];
    ...
    function getDimensionPowerMultiplier(tier) {
        ...
        if (player.infinityUpgrades.includes('dimMult')) dimMult *= 1.125;
        if (player.achievements.includes("r58")) dimMult *= 1.0125;
