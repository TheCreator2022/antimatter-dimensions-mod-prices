function getDimensionBoostPower() {
  ...
  var ret = 4;
  if (player.infinityUpgrades.includes("resetMult")) ret = 5
...
function softReset(bulk) {
  ...
  player = {
    ...
    newsArray: player.newsArray,
      ...
      costMultipliers: [new Decimal(4e5), new Decimal(3e6), new Decimal(2e9), new Decimal(2e11), new Decimal(9e14), new Decimal(5e18), new Decimal(3e22), new Decimal(1e28)],
